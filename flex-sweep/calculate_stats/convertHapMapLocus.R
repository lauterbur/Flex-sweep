...
#        hap_df
      ...
      #write .hap file
        paste(opt$outdir,"/",basename,"_c",as.character(opt$center),"_full.hap",sep="")
        write.table(snps, paste(opt$outdir,"/",basename,"_c",as.character(opt$center),"_full.hap",sep=""), row.names=FALSE, col.names=FALSE, quote=FALSE)
      #write .hap file with positions and columns
        write.table(cbind(phys_positions,hap_isafe), paste(opt$outdir,"/",basename,"_c",as.character(opt$center),"_full.hap.iSAFE",sep=""), sep="\t", row.names=FALSE, col.names=FALSE, quote=FALSE)    
